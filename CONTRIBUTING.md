...
[What should I know before I get started?](#what-should-i-know-before-i-get-started)
  * [EasyFTC Design Decisions](#design-decisions)
...
* [lcrobotics/EasyFTC](https://github.com/lcrobotics/EasyFTC) - EasyFTC Core! This library automatically creates a superClass to extend across multiple OpModes as well as many other tools and organization to make programming more linear.
...
* If the problem started happening recently, **can you reproduce the problem in an older version of EasyFTC?** What's the most recent version in which the problem doesn't happen? You can download older versions of EasyFTC from [the releases page](https://github.com/lcrobotics/EasyFTC/releases).
...
This section guides you through submitting an enhancement suggestion for EasyFTC, including completely new features and minor improvements to existing functionality. Following these guidelines helps maintainers and the community understand your suggestion :pencil: and find related suggestions :mag_right:.

Before creating enhancement suggestions, please check [this list](#before-submitting-an-enhancement-suggestion) as you might find out that you don't need to create one. When you are creating an enhancement suggestion, please [include as many details as possible](#how-do-i-submit-a-good-enhancement-suggestion). Fill in [the template](https://github.com/lcrobotics/EasyFTC/blob/master/.github/ISSUE_TEMPLATE/feature_request.md), including the steps that you imagine you would take if the feature you're requesting existed.
...
All Java must adhere to [Google's Java Style Guide](https://google.github.io/styleguide/javaguide.html).

### Documentation Styleguide

All Documentation should adhere to [Google's Documentation Style Guide](https://developers.google.com/style).
